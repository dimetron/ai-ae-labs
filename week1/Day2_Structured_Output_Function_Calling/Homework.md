...
## 🔥 Бонус-трек: MCP (не оцінюється, не потрібен для сертифіката)
...
- **MCP:** див. окремий розділ «🔥 Бонус-трек: MCP» вище — MCP-клієнт до `https://mcp.silpo.ua/mcp` або MCP-сервер навколо власного інструмента.
...
Інструкція до лаби: [labs/…/Day2_…/README.md](https://github.com/dimetron/ai-ae-labs/blob/main/week1/Day2_Structured_Output_Function_Calling/labs/README.md) — офлайн-старт без ключа, два рівні відмови, troubleshooting, бонус-трек · Стартовий шаблон: [main.go](https://github.com/dimetron/ai-ae-labs/blob/main/week1/Day2_Structured_Output_Function_Calling/labs/main.go) · Офіційний MCP Go SDK: [github.com/modelcontextprotocol/go-sdk](https://github.com/modelcontextprotocol/go-sdk) · MCP-сервер «Сільпо»: [ai-factory.silpo.ua/docs/mcp](https://ai-factory.silpo.ua/docs/mcp) · Monobank open API: [api.monobank.ua/docs](https://api.monobank.ua/docs/index.html) · API-приклади для звірки: [function tools](https://github.com/google/adk-go/blob/v2.4.0/examples/tools/multipletools/main.go), [workflow nodes](https://github.com/google/adk-go/blob/v2.4.0/examples/workflow/basic/main.go)
